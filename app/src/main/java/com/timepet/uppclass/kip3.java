...
public class kip3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kip3);
        ...
        CountDownTimer timer = new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                saveBooleanInSharedPreferences(KEY_BOOLEAN_THREE, false);
                startActivity(new Intent(kip3.this, kipfinish.class));
            }
        };
        ...
        otvet1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                timer.cancel();
                saveBooleanInSharedPreferences(KEY_BOOLEAN_THREE, true);
                startActivity(new Intent(kip3.this, kipfinish.class));
                finish();
            }
        });
